...
const config = {
  title: 'AI-Robot Brain & Vision-Language-Action (VLA) for Humanoid Robotics',
  tagline: 'Educational modules for advanced robotics simulation',
  ...
  projectName: 'T.K-Book', // Usually your repo name.
        ...
        links: [
          {
            ...
            items: [
              ...
              },
              {
                ...
                to: '/docs/module-2/unity-rendering',
              },
              {
                label: 'Module 3: Simulation & Perception',
                to: '/docs/module-3-simulation/intro',
              },
              {
                label: 'Module 4: Planning & Integration',
                to: '/docs/module-4-integration/intro',
              },
            ],
          },
          {
